...
tags: 博客   
---
　如果你看过我的文章会发现我现在的博客样式跟之前是有很大的区别的，之前我也是使用 HEXO 搭建的博客，后来发现使用 HEXO 在多台电脑上发布博客，操作起来并不是那么方便，果断就转到了 Jekyll 上，接下来我会讲如何使用 Jekyll 搭建博客，[博客模板效果](https://zhaohongwei978.github.io/#blog)。
...
　我这里讲的是部署到 Github Page 创建一个 github 账号，然后创建一个跟你账户名一样的仓库，如我的 github 账户名叫 [zhaohongwei978](https://github.com/zhaohongwei978)，我的 github 仓库名就叫 [zhaohongwei978.github.io](https://github.com/zhaohongwei978/zhaohongwei978.github.io)，创建好了之后，把刚才建立的 myBlog 项目 push 到 username.github.io仓库里去（username指的是你的github用户名），检查你远端仓库已经跟你本地 myBlog 同步了，然后你在浏览器里输入 username.github.io ，就可以访问你的博客了。
...
首先你要获取的我博客，[Github项目地址](https://github.com/zhaohongwei978/zhaohongwei978.github.io.git)，你可以直接[点击下载博客](https://github.com/zhaohongwei978/zhaohongwei978.github.io/archive/master.zip)，zhaohongwei978.github.io/ 目录下， 使用命令部署本地服务
...
```
Configuration file: /Users/tendcloud-Caroline/Desktop/zhaohongwei978.github.io/_config.yml
...
```
Configuration file: /Users/xiaomei/Desktop/OpenSource/Mine/Page-Blog/zhaohongwei978.github.io-github/_config.yml
            Source: /Users/xiaomei/Desktop/OpenSource/Mine/Page-Blog/zhaohongwei978.github.io-github
       Destination: /Users/xiaomei/Desktop/OpenSource/Mine/Page-Blog/zhaohongwei978.github.io-github/_site
 Incremental build: disabled. Enable with --incremental
      Generating... 
                    done in 0.901 seconds.
 Auto-regeneration: enabled for '/Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/zhaohongwei978.github.io-github'
Configuration file: /Users/baixinpan/Desktop/OpenSource/Mine/Page-Blog/zhaohongwei978.github.io-github/_config.yml
...
> 问题：最近很多朋友使用我的模板报警告：The CNAME `zhaohongwei978.github.io` is already taken
> 解决：把CNAME里面的zhaohongwei978.github.io修改成你自己的域名，如果你暂时没有域名，CNAME里面就什么都不用谢。（之前没人反馈过这个问题，应该是github page最近才最的限制。）
